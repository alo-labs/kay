    ...
    fn render_pick_mode(&self, area: Rect, buf: &mut Buffer) {
        let mut lines: Vec<Line> = vec![
            ...
            Line::from(vec![
                Span::raw("  "),
                Span::styled(
                    "or connect provider API keys for Xiaomi, OpenCode Go, MiniMax, OpenRouter, or OpenAI",
                    Style::default().add_modifier(Modifier::BOLD),
                ),
            ]),
            Line::from(""),
        ...
        lines.extend(create_mode_item(
            ...
            AuthMode::ApiKey,
            api_key_label,
            "Xiaomi, OpenCode Go, MiniMax, OpenRouter, or OpenAI",
        ));
        lines.push(Line::from(""));
        lines.push(
...
mod tests {
    ...
    fn onboarding_pick_mode_mentions_provider_keys_explicitly() {
        ...
        assert!(rendered.contains("Xiaomi, OpenCode Go, MiniMax, OpenRouter, or OpenAI"));
    }
