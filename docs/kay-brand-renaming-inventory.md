...
`docs/example-config.md`, `code-rs/cli/src/main.rs`,
...
`code-rs/tui/src/chatwidget.rs`, `code-rs/tui/src/lib.rs`,
`code-rs/tui/src/model_migration.rs`, and
`code-rs/login/src/assets/success.html`.
...
| Workspace path and binary roots | `code-rs/`, `code-rs/bin/code`, `code-rs/target`, `~/.code`, `KAY_HOME` | rename-with-compat | High-risk path migration. Keep temporary aliases until packaging, shell helpers, and docs all switch cleanly. |
