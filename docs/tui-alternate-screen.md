...
This detection happens in the helper function `determine_alt_screen_mode()` in `kay-rs/tui/src/lib.rs`.

### Configuration Schema

The `AltScreenMode` enum is defined in `kay-rs/protocol/src/config_types.rs` and serializes to lowercase TOML:
