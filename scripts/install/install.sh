...
STANDALONE_ROOT="$KAY_HOME_DIR/packages/standalone"
...
release_url_for_asset() {
  ...
  printf 'https://github.com/alo-labs/kay/releases/download/v%s/%s\n' "$resolved_version" "$asset"
}

release_metadata_url() {
  resolved_version="$1"

  printf 'https://api.github.com/repos/alo-labs/kay/releases/tags/v%s\n' "$resolved_version"
}
...
resolve_version() {
  ...
  release_json="$(download_text "https://api.github.com/repos/alo-labs/kay/releases/latest")"
